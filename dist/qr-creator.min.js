...
var I=null,J=class{};J.render=async function(D,E){await I(D,E)};globalThis.QrCreator=J;
...
d;h+=1){var e=b.left+h*m,g=b.top+c*m,l=m;x(f,a,b,e,g,l,c,h)}a.fill()}await F(t,a,b);return k}async function n(k){var b=document.createElement("canvas");b.width=k.size;b.height=k.size;return H(b,k)}var v={A:1,v:40,u:"L",left:0,top:0,size:200,fill:"#000",background:null,text:"no text",F:.5,D:0,cornerColor:null,icon:{src:null,width:null,height:null,crossOrigin:null}};I=async function(k,b){var a={};Object.assign(a,v,k);a.A=a.minVersion;a.v=a.maxVersion;a.u=a.ecLevel;a.left=a.left;a.top=a.top;a.size=a.size;
a.fill=a.fill;a.background=a.background;a.text=a.text;a.F=a.radius;a.D=a.quiet;a.icon=a.icon;if(b instanceof HTMLCanvasElement){if(b.width!==a.size||b.height!==a.size)b.width=a.size,b.height=a.size;b.getContext("2d").clearRect(0,0,b.width,b.height);return H(b,a)}(k=await n(a))&&b.appendChild(k);return k}})(function(){function D(n){var v=F.W(n);return{$:function(){return 4},h:function(){return v.length},write:function(k){for(var b=0;b<v.length;b+=1)k.put(v[b],8)}}}function E(){var n=[],v=0,k={N:function(){return n},
i:function(b){return 1==(n[Math.floor(b/8)]>>>7-b%8&1)},put:function(b,a){if(32<a)throw Error("Length too large for bit operations");for(var f=0;f<a;f+=1)k.C(1==(b>>>a-f-1&1))},j:function(){return v},C:function(b){var a=Math.floor(v/8);n.length<=a&&n.push(0);b&&(n[a]|=128>>>v%8);v+=1}};return k}function F(n,v){function k(h,q){for(var e=-1;7>=e;e+=1)if(!(-1>=h+e||c<=h+e))for(var g=-1;7>=g;g+=1)-1>=q+g||c<=q+g||(f[h+e][q+g]=0<=e&&6>=e&&(0==g||6==g)||0<=g&&6>=g&&(0==e||6==e)||2<=e&&4>=e&&2<=g&&4>=g?
!0:!1)}function b(h,q){for(var e=c=4*n+17,g=Array(e),l=0;l<e;l+=1){g[l]=Array(e);for(var u=0;u<e;u+=1)g[l][u]=null}f=g;k(0,0);k(c-7,0);k(0,c-7);e=x.S(n);for(g=0;g<e.length;g+=1)for(l=0;l<e.length;l+=1){u=e[g];var w=e[l];if(null==f[u][w])for(var r=-2;2>=r;r+=1)for(var p=-2;2>=p;p+=1)f[u+r][w+p]=-2==r||2==r||-2==p||2==p||0==r&&0==p}for(e=8;e<c-8;e+=1)null==f[e][6]&&(f[e][6]=0==e%2);for(e=8;e<c-8;e+=1)null==f[6][e]&&(f[6][e]=0==e%2);e=x.J(a<<3|q);for(g=0;15>g;g+=1)l=!h&&1==(e>>g&1),f[6>g?g:8>g?g+1:c-
15+g][8]=l,f[8][8>g?c-g-1:9>g?15-g:14-g]=l;f[c-8][8]=!h;if(7<=n){e=x.K(n);for(g=0;18>g;g+=1)l=!h&&1==(e>>g&1),f[Math.floor(g/3)][g%3+c-8-3]=l;for(g=0;18>g;g+=1)l=!h&&1==(e>>g&1),f[g%3+c-8-3][Math.floor(g/3)]=l}if(null==d){h=H.T(n,a);e=E();for(g=0;g<m.length;g+=1)l=m[g],e.put(4,4),e.put(l.h(),x.j(4,n)),l.write(e);for(g=l=0;g<h.length;g+=1)l+=h[g].s;if(e.j()>8*l)throw Error("code length overflow. ("+e.j()+">"+8*l+")");for(e.j()+4<=8*l&&e.put(0,4);0!=e.j()%8;)e.C(!1);for(;!(e.j()>=8*l);){e.put(236,8);
if(e.j()>=8*l)break;e.put(17,8)}var z=0;l=g=0;u=Array(h.length);w=Array(h.length);for(r=0;r<h.length;r+=1){var C=h[r].s,G=h[r].G-C;g=Math.max(g,C);l=Math.max(l,G);u[r]=Array(C);for(p=0;p<u[r].length;p+=1)u[r][p]=255&e.N()[p+z];z+=C;p=x.O(G);C=A(u[r],p.h()-1).B(p);w[r]=Array(p.h()-1);for(p=0;p<w[r].length;p+=1)G=p+C.h()-w[r].length,w[r][p]=0<=G?C.i(G):0}for(p=e=0;p<h.length;p+=1)e+=h[p].G;e=Array(e);for(p=z=0;p<g;p+=1)for(r=0;r<h.length;r+=1)p<u[r].length&&(e[z]=u[r][p],z+=1);for(p=0;p<l;p+=1)for(r=
0;r<h.length;r+=1)p<w[r].length&&(e[z]=w[r][p],z+=1);d=e}h=d;e=-1;g=c-1;l=7;u=0;q=x.R(q);for(w=c-1;0<w;w-=2)for(6==w&&--w;;){for(r=0;2>r;r+=1)null==f[g][w-r]&&(p=!1,u<h.length&&(p=1==(h[u]>>>l&1)),q(g,w-r)&&(p=!p),f[g][w-r]=p,--l,-1==l&&(u+=1,l=7));g+=e;if(0>g||c<=g){g-=e;e=-e;break}}}var a=B[v],f=null,c=0,d=null,m=[],t={I:function(h){h=D(h);m.push(h);d=null},g:function(h,q){if(0>h||c<=h||0>q||c<=q)throw Error(h+","+q);return f[h][q]},m:function(){return c},U:function(){for(var h=0,q=0,e=0;8>e;e+=
1){b(!0,e);var g=x.P(t);if(0==e||h>g)h=g,q=e}b(!1,q)}};return t}function A(n,v){if("undefined"==typeof n.length)throw Error(n.length+"/"+v);var k=function(){for(var a=0;a<n.length&&0==n[a];)a+=1;for(var f=Array(n.length-a+v),c=0;c<n.length-a;c+=1)f[c]=n[c+a];return f}(),b={i:function(a){return k[a]},h:function(){return k.length},multiply:function(a){for(var f=Array(b.h()+a.h()-1),c=0;c<b.h();c+=1)for(var d=0;d<a.h();d+=1)f[c+d]^=y.o(y.l(b.i(c))+y.l(a.i(d)));return A(f,0)},B:function(a){if(0>b.h()-
a.h())return b;for(var f=y.l(b.i(0))-y.l(a.i(0)),c=Array(b.h()),d=0;d<b.h();d+=1)c[d]=b.i(d);for(d=0;d<a.h();d+=1)c[d]^=y.o(y.l(a.i(d))+f);return A(c,0).B(a)}};return b}F.W=function(n){if("undefined"!==typeof TextEncoder)n=(new TextEncoder).encode(n);else{const v=[];for(let k=0;k<n.length;k++){let b=n.charCodeAt(k);128>b?v.push(b):2048>b?v.push(192|b>>6,128|b&63):55296>b||57344<=b?v.push(224|b>>12,128|b>>6&63,128|b&63):(k++,b=(b&1023)<<10|n.charCodeAt(k)&1023,b+=65536,v.push(240|b>>18,128|b>>12&63,
128|b>>6&63,128|b&63))}n=v}return n};var B={Y:1,Z:0,Q:3,X:2},x=function(){function n(b){for(var a=0;0!=b;)a+=1,b>>>=1;return a}var v=[[],[6,18],[6,22],[6,26],[6,30],[6,34],[6,22,38],[6,24,42],[6,26,46],[6,28,50],[6,30,54],[6,32,58],[6,34,62],[6,26,46,66],[6,26,48,70],[6,26,50,74],[6,30,54,78],[6,30,56,82],[6,30,58,86],[6,34,62,90],[6,28,50,72,94],[6,26,50,74,98],[6,30,54,78,102],[6,28,54,80,106],[6,32,58,84,110],[6,30,58,86,114],[6,34,62,90,118],[6,26,50,74,98,122],[6,30,54,78,102,126],[6,26,52,78,
104,130],[6,30,56,82,108,134],[6,34,60,86,112,138],[6,30,58,86,114,142],[6,34,62,90,118,146],[6,30,54,78,102,126,150],[6,24,50,76,102,128,154],[6,28,54,80,106,132,158],[6,32,58,84,110,136,162],[6,26,54,82,110,138,166],[6,30,58,86,114,142,170]],k={J:function(b){for(var a=b<<10;0<=n(a)-n(1335);)a^=1335<<n(a)-n(1335);return(b<<10|a)^21522},K:function(b){for(var a=b<<12;0<=n(a)-n(7973);)a^=7973<<n(a)-n(7973);return b<<12|a},S:function(b){return v[b-1]},R:function(b){switch(b){case 0:return function(a,
...
67,46,16],[19,148,118,6,149,119],[18,75,47,31,76,48],[34,54,24,34,55,25],[20,45,15,61,46,15]],k={T:function(b,a){var f=n(b,a);if("undefined"==typeof f)throw Error("bad rs block @ typeNumber:"+b+"/errorCorrectLevel:"+a);b=f.length/3;a=[];for(var c=0;c<b;c+=1)for(var d=f[3*c],m=f[3*c+1],t=f[3*c+2],h=0;h<d;h+=1){var q=a,e=q.push,g=t,l={};l.G=m;l.s=g;e.call(q,l)}return a}};return k}();return F}());})();
